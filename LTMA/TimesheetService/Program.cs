...
// Connect TimesheetService to its own database.
builder.Services.AddDbContext<TimesheetDbContext>(options =>
    options.UseSqlServer(builder.Configuration.GetConnectionString("TimesheetConnection")));

// TimesheetService uses this client to get employee information.
...
// Register timesheet business logic.
builder.Services.AddScoped<ITimesheetService, TimesheetService.Services.TimesheetService>();
